...
| Sebastian Krawiec     | Updated the webpages to properly close the modal containing products that gets displayed when updating an order. I also implemented a sanitation check (prevents existing items from being added to the list of products on order) On the function addToOrder. Updated several SQL queries and ProductAPIController in order to curb the duplication issue that occurs when products are added to an order. |
| Dilip Sai Reddy Mettu |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Jay Kukadiya          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
